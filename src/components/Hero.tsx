...
export default function Hero({ profile }: HeroProps) {
    ...
    return (
        <>
            <div className="relative w-full overflow-hidden min-h-screen sm:min-h-[90vh] flex flex-col items-center justify-center z-0">
                <div className="absolute inset-0 z-0">
                    {isDesktop ? (
                        <DarkVeil
                            hueShift={0}
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-[#0a0118] via-[#1a0b2e] to-black" />
                    )}
                </div>
                <section className="relative z-10 w-full flex flex-col gap-4 sm:gap-6 items-center justify-center px-4 sm:px-6 md:px-12 lg:px-24 py-10 sm:py-6">
                    <motion.div
